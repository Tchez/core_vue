...
from .serializers import ContatoGETSerializer, ContatoSerializer


class ContatoViewAPI(ModelViewSet):
    """Classe para gerenciar as requisições da API para POST, PUT, PATCH e DELETE"""

    authentication_classes = [JWTAuthentication, SessionAuthentication]
    permission_classes = [IsAuthenticated]
    queryset = Contato.objects.select_related().all()
    serializer_class = ContatoSerializer


class ContatoCustomViewAPI(OptimizedQuerySetMixin, ReadOnlyModelViewSet):
    ...
    queryset = Contato.objects.select_related().all()
    serializer_class = ContatoGETSerializer
